...
import pro.aquaone.util.exception.ModificationRestrictionException;
...
public class AbstractUIController {
   ...
   public User create(UserTo userTo) {
    ...
    public List<Cart> getBetweenWithId(LocalDate startDate, LocalTime startTime, LocalDate endDate, LocalTime endTime) {
        int userId = SecurityUtil.authUserId();
        log.info("getBetween dates({} - {}) time({} - {}) for user {}", startDate, endDate, startTime, endTime, userId);
        return cartService.getBetweenDatesWithUserId(startDate, endDate, userId);
    }

    public List<Cart> getBetween(LocalDate startDate, LocalTime startTime, LocalDate endDate, LocalTime endTime) {
        int userId = SecurityUtil.authUserId();
        log.info("getBetween dates({} - {}) time({} - {}) for user {}", startDate, endDate, startTime, endTime, userId);
        return cartService.getBetweenDates(startDate, endDate);
    }
