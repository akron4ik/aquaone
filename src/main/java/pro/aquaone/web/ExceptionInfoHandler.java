...
import pro.aquaone.util.ValidationUtil;
import pro.aquaone.util.exception.ApplicationException;
import pro.aquaone.util.exception.ErrorInfo;
...
import static pro.aquaone.util.exception.ErrorType.*;
