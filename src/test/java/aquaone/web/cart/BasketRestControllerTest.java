...
class BasketRestControllerTest extends AbstractControllerTest {
    private static final String URL = "/cart/";

    @Test
    void get() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.get(URL + "100008").with(userHttpBasic(USER)))
    ...
    void delete() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.delete(URL + "100008")
